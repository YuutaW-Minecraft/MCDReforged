...
class BaseBot:
    ...
    @contextlib.contextmanager
    def with_token(self, bot_token: base.String, validate_token: Optional[base.Boolean] = ...):
        ...
    ...
    async def download_file(self, file_path: base.String, destination: Optional[base.InputFile] = ..., timeout: Optional[base.Integer] = ..., chunk_size: Optional[base.Integer] = ..., seek: Optional[base.Boolean] = ...) -> Union[io.BytesIO, io.FileIO]:
        """
