...
class ReplyKeyboardMarkup(base.TelegramObject):
    ...
    def __init__(self, keyboard: typing.List[typing.List[KeyboardButton]] = ..., resize_keyboard: base.Boolean = ..., one_time_keyboard: base.Boolean = ..., selective: base.Boolean = ..., row_width: base.Integer = ...) -> None:
        ...
