...
class Chat(base.TelegramObject):
    ...
    async def kick(self, user_id: base.Integer, until_date: typing.Union[base.Integer, datetime.datetime, datetime.timedelta, None] = ...) -> base.Boolean:
        """
    ...
    async def unban(self, user_id: base.Integer, only_if_banned: typing.Optional[base.Boolean] = ...) -> base.Boolean:
        """
    ...
    async def pin_message(self, message_id: base.Integer, disable_notification: typing.Optional[base.Boolean] = ...) -> base.Boolean:
        """
    ...
    async def unpin_message(self, message_id: typing.Optional[base.Integer] = ...) -> base.Boolean:
        """
