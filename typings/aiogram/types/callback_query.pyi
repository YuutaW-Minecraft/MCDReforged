...
class CallbackQuery(base.TelegramObject):
    ...
    chat_instance: base.String = ...
    data: base.String = ...
    game_short_name: base.String = ...
    async def answer(self, text: typing.Optional[base.String] = ..., show_alert: typing.Optional[base.Boolean] = ..., url: typing.Optional[base.String] = ..., cache_time: typing.Optional[base.Integer] = ...):
        """
