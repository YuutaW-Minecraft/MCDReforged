...
class InputMediaAnimation(InputMedia):
    ...
    def __init__(self, media: base.InputFile, thumb: typing.Union[base.InputFile, base.String] = ..., caption: base.String = ..., width: base.Integer = ..., height: base.Integer = ..., duration: base.Integer = ..., parse_mode: base.String = ..., caption_entities: typing.Optional[typing.List[MessageEntity]] = ..., **kwargs) -> None:
        ...
...
class InputMediaPhoto(InputMedia):
    ...
    """
    def __init__(self, media: base.InputFile, caption: base.String = ..., parse_mode: base.String = ..., caption_entities: typing.Optional[typing.List[MessageEntity]] = ..., **kwargs) -> None:
        ...
...
class InputMediaVideo(InputMedia):
    ...
    def __init__(self, media: base.InputFile, thumb: typing.Union[base.InputFile, base.String] = ..., caption: base.String = ..., width: base.Integer = ..., height: base.Integer = ..., duration: base.Integer = ..., parse_mode: base.String = ..., caption_entities: typing.Optional[typing.List[MessageEntity]] = ..., supports_streaming: base.Boolean = ..., **kwargs) -> None:
        ...
...
class MediaGroup(base.TelegramObject):
    ...
    def attach_photo(self, photo: typing.Union[InputMediaPhoto, base.InputFile], caption: base.String = ...):
        """
        Attach photo
    ...
    def attach_video(self, video: typing.Union[InputMediaVideo, base.InputFile], thumb: typing.Union[base.InputFile, base.String] = ..., caption: base.String = ..., width: base.Integer = ..., height: base.Integer = ..., duration: base.Integer = ...):
        """
        Attach video
