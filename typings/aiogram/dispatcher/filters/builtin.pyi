...
class Command(Filter):
    ...
    """
    def __init__(self, commands: Union[Iterable, str], prefixes: Union[Iterable, str] = ..., ignore_case: bool = ..., ignore_mention: bool = ..., ignore_caption: bool = ...) -> None:
        """
    ...
    @classmethod
    async def check_command(cls, message: types.Message, commands, prefixes, ignore_case=..., ignore_mention=..., ignore_caption=...):
        ...
