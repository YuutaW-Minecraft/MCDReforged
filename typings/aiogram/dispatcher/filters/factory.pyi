...
class FiltersFactory:
    ...
    def bind(self, callback: typing.Union[typing.Callable, AbstractFilter], validator: typing.Optional[typing.Callable] = ..., event_handlers: typing.Optional[typing.List[Handler]] = ..., exclude_event_handlers: typing.Optional[typing.Iterable[Handler]] = ...):
        """
        Register filter
