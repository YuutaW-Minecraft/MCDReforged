...
class SendMessage(BaseResponse, ReplyToMixin, ParseModeMixin, DisableNotificationMixin, DisableWebPagePreviewMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Union[Integer, String] = ..., text: String = ..., parse_mode: Optional[String] = ..., disable_web_page_preview: Optional[Boolean] = ..., disable_notification: Optional[Boolean] = ..., reply_to_message_id: Optional[Integer] = ..., reply_markup: Optional[Union[types.InlineKeyboardMarkup, types.ReplyKeyboardMarkup, Dict, String]] = ...) -> None:
        """
...
class ForwardMessage(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Union[Integer, String] = ..., from_chat_id: Union[Integer, String] = ..., message_id: Integer = ..., disable_notification: Optional[Boolean] = ...) -> None:
        """
...
class SendPhoto(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Union[Integer, String], photo: String, caption: Optional[String] = ..., disable_notification: Optional[Boolean] = ..., reply_to_message_id: Optional[Integer] = ..., reply_markup: Optional[Union[types.InlineKeyboardMarkup, types.ReplyKeyboardMarkup, Dict, String]] = ...) -> None:
        """
...
class SendDocument(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Union[Integer, String], document: String, caption: Optional[String] = ..., disable_notification: Optional[Boolean] = ..., reply_to_message_id: Optional[Integer] = ..., reply_markup: Optional[Union[types.InlineKeyboardMarkup, types.ReplyKeyboardMarkup, Dict, String]] = ...) -> None:
        """
        :param chat_id: Union[Integer, String] - Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
...
class SendVoice(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Union[Integer, String], voice: String, caption: Optional[String] = ..., duration: Optional[Integer] = ..., disable_notification: Optional[Boolean] = ..., reply_to_message_id: Optional[Integer] = ..., reply_markup: Optional[Union[types.InlineKeyboardMarkup, types.ReplyKeyboardMarkup, Dict, String]] = ...) -> None:
        """
        :param chat_id: Union[Integer, String] - Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
...
class SendVideoNote(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Union[Integer, String], video_note: String, duration: Optional[Integer] = ..., length: Optional[Integer] = ..., disable_notification: Optional[Boolean] = ..., reply_to_message_id: Optional[Integer] = ..., reply_markup: Optional[Union[types.InlineKeyboardMarkup, types.ReplyKeyboardMarkup, Dict, String]] = ...) -> None:
        """
        :param chat_id: Union[Integer, String] - Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
...
class SendMediaGroup(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Union[Integer, String], media: Union[types.MediaGroup, List] = ..., disable_notification: typing.Optional[Boolean] = ..., reply_to_message_id: typing.Optional[Integer] = ...) -> None:
        """
        Use this method to send a group of photos or videos as an album.
...
class SendLocation(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Union[Integer, String], latitude: Float, longitude: Float, disable_notification: Optional[Boolean] = ..., reply_to_message_id: Optional[Integer] = ..., reply_markup: Optional[Union[types.InlineKeyboardMarkup, types.ReplyKeyboardMarkup, Dict, String]] = ...) -> None:
        """
        :param chat_id: Union[Integer, String] - Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
...
class SendContact(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Union[Integer, String], phone_number: String, first_name: String, last_name: Optional[String] = ..., disable_notification: Optional[Boolean] = ..., reply_to_message_id: Optional[Integer] = ..., reply_markup: Optional[Union[types.InlineKeyboardMarkup, types.ReplyKeyboardMarkup, Dict, String]] = ...) -> None:
        """
...
class SendSticker(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Union[Integer, String], sticker: String, disable_notification: Optional[Boolean] = ..., reply_to_message_id: Optional[Integer] = ..., reply_markup: Optional[Union[types.InlineKeyboardMarkup, types.ReplyKeyboardMarkup, Dict, String]] = ...) -> None:
        """
        :param chat_id: Union[Integer, String] - Unique identifier for the target chat or username
            of the target channel (in the format @channelusername)
...
class SendGame(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    __slots__ = ...
    method = ...
    def __init__(self, chat_id: Integer, game_short_name: String, disable_notification: Optional[Boolean] = ..., reply_to_message_id: Optional[Integer] = ..., reply_markup: Optional[types.InlineKeyboardMarkup] = ...) -> None:
        """
