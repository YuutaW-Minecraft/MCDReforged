...
class Dispatcher(DataMixin, ContextInstanceMixin):
    ...
    async def process_updates(self, updates, fast: typing.Optional[bool] = ...):
        """
    ...
    async def start_polling(self, timeout=..., relax=..., limit=..., reset_webhook=..., fast: typing.Optional[bool] = ..., error_sleep: int = ...):
        """
        Start long-polling
    ...
    def message_handler(self, *custom_filters, commands=..., regexp=..., content_types=..., state=..., run_task=..., **kwargs):
        """
    ...
    def register_edited_message_handler(self, callback, *custom_filters, commands=..., regexp=..., content_types=..., state=..., run_task=..., **kwargs):
        """
    ...
    def throttled(self, on_throttled: typing.Optional[typing.Callable] = ..., key=..., rate=..., user_id=..., chat_id=...):
        """
    ...
    def bind_filter(self, callback: typing.Union[typing.Callable, AbstractFilter], validator: typing.Optional[typing.Callable] = ..., event_handlers: typing.Optional[typing.List[Handler]] = ..., exclude_event_handlers: typing.Optional[typing.Iterable[Handler]] = ...):
        """
        Register filter
